/**
 * ============================================================
 *  FRONTEND — RÉSERVATIONS DE VÉHICULES
 * ============================================================
 *  Composant complet pour la gestion des réservations de
 *  véhicules côté client : formulaire de réservation,
 *  vérification de disponibilité et ajout au panier.
 *
...
/**
 * Modal de réservation de véhicule (client).
 * Vérifie la disponibilité, notifie le serveur et ajoute au panier localStorage.
 */
export default function VehicleReservations({ vehicle, onClose, navigateTo }) {
